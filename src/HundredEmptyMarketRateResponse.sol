...
interface IHundredEmptyMarketRateEnvironmentRegistryResponseView {
...
contract HundredEmptyMarketRateResponse {
    ...
    function handleIncident(TrapAlert calldata alert) external {
        ...
        IHundredEmptyMarketRateEnvironmentRegistryResponseView registry = IHundredEmptyMarketRateEnvironmentRegistryResponseView(REGISTRY);
